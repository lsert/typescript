...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lit_html__ = __webpack_require__(1);
...
let dom = (data) => __WEBPACK_IMPORTED_MODULE_0_lit_html__["a" /* html */]`
    <div>呵呵哒${data.name}</div>
    <div><span>${1 > 0 ? data.msg : '我不知道啊'}你大爷的啊 ${data.title}</span></div>
    ${isL ? (
        __WEBPACK_IMPORTED_MODULE_0_lit_html__["a" /* html */]`<p>这里是p${timer}</p>`
    ) : (__WEBPACK_IMPORTED_MODULE_0_lit_html__["a" /* html */]`<p>这里是div${msg}</p>`)}
`;

Object(__WEBPACK_IMPORTED_MODULE_0_lit_html__["b" /* render */])(dom(data), document.body);
